...
auto icosahedron = [&]()
{
  ...
  set.balls[10].dest_set = "hill-test";
  set.balls[10].dest_ball_id = 1;

  set.overlaps.push_back(Landscape::Set::Overlap(6,10, "tree-hill-test", 1));
...
auto icos2 = [&]()
{
  land.sets.push_back(Landscape::Set("icos2", 12));
  Landscape::Set &set = land.sets.back();
  set.colour = Eigen::Vector4d(0.7,0.6,0.55,1);
  const double pi = 3.14159265;
